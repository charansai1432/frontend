        ...
        <div className="space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="info-card">
              ...
              <p className="text-xl text-gray-500 font-semibold">Street: <span className="text-gray-800">{company?.address?.streetAddress}</span></p>
              <p className="text-xl text-gray-500 font-semibold">City: <span className="text-gray-800">{company?.address?.city}</span></p>
              <p className="text-xl text-gray-500 font-semibold">Postal Code: <span className="text-gray-800">{company?.address?.postalCode}</span></p>
              <p className="text-xl text-gray-500 font-semibold">State: <span className="text-gray-800">{company?.address?.state}</span></p>
              <p className="text-xl text-gray-500 font-semibold">Country: <span className="text-gray-800">{company?.address?.country}</span></p>
            </div>
            <div className="info-card">
              <p className="text-sm text-gray-500 font-medium">Website</p>
              <a href={companyWebsite} target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline text-xl font-semibold">
            ...
            <div className="info-card">
              ...
              <a href={businessFileUrl} target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline text-xl font-semibold">
                View Business File
              </a>
            </div>
          </div>
          ...
          <div className="flex justify-end space-x-6 mt-8">
            <button onClick={() => navigate(`/admin/recruiters/${companyId}`)} className="px-6 py-3 text-white bg-blue-700 rounded-md hover:bg-blue-800 transition">
              Recruiters List
            </button>
            <button onClick={handleDeleteCompany} className={`px-6 py-3 text-white bg-red-600 rounded-md hover:bg-red-700 transition duration-200 ${dloading && "cursor-not-allowed"}`} disabled={dloading}>
